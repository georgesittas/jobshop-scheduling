...
that the last job is scheduled as early as possible. The implementation utilizes the CSP libraries `ic` and `branch_and_bound`, which
makes ECLiPSe Prolog a dependency.
